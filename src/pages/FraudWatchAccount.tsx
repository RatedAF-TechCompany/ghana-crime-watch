...
export default function FraudWatchAccount() {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/fraud-watch/search"><Button>Search Accounts</Button></Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-primary text-primary-foreground py-6">
        <div className="container max-w-3xl mx-auto px-4">
          <Link to="/fraud-watch/search" className="inline-flex items-center gap-1 text-primary-foreground/70 hover:text-primary-foreground text-sm mb-4">
      ...
      <div className="container max-w-3xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <Link to={`/fraud-watch/report?account=${account.account_name}&platform=${account.platform}&handle=${account.account_handle || ""}`} className="flex-1">
